...
/**
 * A converter of Timestamping service transaction messages.
 */
public final class ServiceTransactionConverter implements TransactionConverter {
  ...
  static final ImmutableMap<Integer, Function<byte[], Transaction>> TRANSACTION_FACTORIES =
      ImmutableMap.<Integer, Function<byte[], Transaction>>builder()
          .put(CREATE_TIMESTAMP.id(), TimestampTx::fromBytes)
          .build();
