...
/**
 * Properties about the timestamping service artifact.
 */
public final class TimestampingArtifactInfo {
  ...
  public static final String TIMESTAMPING_SERVICE_NAME = "timestamping";
  public static final int TIMESTAMPING_SERVICE_ID = 101;
  public static final ServiceConfiguration TIMESTAMPING_SERVICE_INITIAL_CONFIG =
  ...
  /**
   * Creates a testkit builder with Timestamping service and time service with
   * the instance parameters as specified in the constants. Time service will
  ...
  /**
   * Creates a testkit builder with Timestmaping service and time service with
   * the instance parameters as specified in the constants.
   *
  ...
  public static Builder createQaServiceTestkit(TimeProvider timeProvider) {
    return TestKit.builder()
        ...
        .withService(ARTIFACT_ID, TIMESTAMPING_SERVICE_NAME, TIMESTAMPING_SERVICE_ID, TIMESTAMPING_SERVICE_INITIAL_CONFIG)
        .withTimeService(TIME_SERVICE_NAME, TIME_SERVICE_ID, timeProvider);
  }

  private TimestampingArtifactInfo() {
  }
}
